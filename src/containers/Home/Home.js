        ...
        return(
            <div>
                ...
                <div className="uk-section-large">
                    ...
                    <div className="uk-margin-medium-top uk-container">
                        <div className="twitter-section uk-child-width-1-2@m uk-child-width-1-1@s">
                            <div className="">
                                ...
                                <a href="https://twitter.com/EndlessGamingEG" className="twitter">
                                    ...
                                    <span className="right">
                                        Follow us <span>EndlessGamingEG</span>
                                    </span>
                                </a>
                            </div>
                    ...
                    <div className="uk-container uk-margin-medium-top stream-section">
                        ...
                        <ul className="uk-switcher uk-margin">
                            <li>
                                <div className="uk-grid-collapse uk-text-center uk-grid-match" uk-grid="true">
                                    <div className="uk-width-3-4@m">
                                        <StreamCard large={true}/>
                                    </div>
